...
_dev:need:graphical_environment:()
{
   ...
   if ! :yum:is_installed --environment 'Server with GUI'; then
      ...
      local -a _dev__need__graphical_environment_____Items=(                               # For @^ and @ shorthand, see yum -v grouplist and man 8 yum
      ...
      yum -y install "${_dev__need__graphical_environment_____Items[@]}"                   # Install items specified above
