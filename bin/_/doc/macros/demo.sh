...
_doc:macros:demo:demofunc()
{
   cat <<'EOF'

NAMESPACE PROTECTION: idioms in demofunc() in file _/doc/macros/demo.sh

_doc:macros:demo:References
   ...
   FUNCTION VARIABLES
      \(.)_var         (.)_var          _doc__macros__demo__demofunc___var

_doc:macros:demo:Function Declarations
