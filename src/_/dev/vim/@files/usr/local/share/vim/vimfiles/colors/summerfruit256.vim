...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    " Global
    call <SID>X("Normal", "000000", "fdfcf2", "")
    call <SID>X("NonText", "438ec3", "eeeeee", "")

    " Search
    call <SID>X("Search", "800000", "ffff66", "")
    call <SID>X("IncSearch", "800000", "ffff99", "")

    " Interface Elements
    call <SID>X("StatusLine", "000000", "ffff44", "bold")
    call <SID>X("StatusLineNC", "666666", "ffff00", "")
    ...
    exec "hi CursorLine cterm=bold ctermbg=253 guifg=NONE"
    call <SID>X("LineNr", "eeeeee", "438ec3", "bold")
"   call <SID>X("MatchParen", "000000", "d7ffaf", "")
    call <SID>X("MatchParen", "000000", "438ec3", "")
    exec "hi MatchParen ctermbg=159 term=NONE cterm=NONE"
    call <SID>X("ShowMarksHLl", "000000", "d9eeff", "")
    call <SID>X("ShowMarksHLu", "000000", "d9eeff", "")
    call <SID>X("ShowMarksHLo", "000000", "ffdada", "")
    call <SID>X("ShowMarksHLm", "000000", "ffff00", "bold")

    " Specials
    call <SID>X("Todo", "e50808", "dbf3cd", "bold")
    call <SID>X("Title", "000000", "", "")
    call <SID>X("Special", "5f00ff", "", "")
    call <SID>X("SpecialKey", "fd8900", "", "")
    call <SID>X("Directory", "af5f00", "", "")
    call <SID>X("MoreMsg", "fd8900", "", "")
    call <SID>X("WarningMsg", "fd8900", "", "")
    call <SID>X("Question", "fd8900", "", "")

    " Syntax Elements
    call <SID>X("String", "005fd7", "", "")
    call <SID>X("Constant", "005fd7", "", "")
    call <SID>X("Number", "005fd7", "", "")
    call <SID>X("Statement", "5f0000", "", "")
    call <SID>X("Function", "d70000", "", "")
    call <SID>X("PreProc", "d70000", "", "")
    call <SID>X("Type", "005fff", "", "")
    ...
    call <SID>X("jinjaString", "005fd7", "fbf4c7", "")
    call <SID>X("jinjaNumber", "bf0945", "fbf4c7", "bold")
    call <SID>X("jinjaStatement", "5f0000", "fbf4c7", "bold")
    ...
    " Java Highlighting
    call <SID>X("javaFold", "af0000", "", "")

    " Diff Highlighting
    call <SID>X("DiffChange", "000000", "ace0f7", "")
    call <SID>X("DiffAdd", "000000", "ffd787", "")
    call <SID>X("DiffText", "000000", "ffa0a0", "")
    call <SID>X("DiffDelete", "f0f0f0", "f0f0f0", "")

    " JSON Highlighting
    call <SID>X("jsonMacroDefault", "005fd7", "ffffff", "bold")
    exec "hi jsonMacroDefault ctermfg=26 ctermbg=NONE term=NONE cterm=bold"

    call <SID>X("jsonMacroKey", "005f00", "ffffff", "bold")
    exec "hi jsonMacroKey ctermfg=22 ctermbg=NONE term=NONE cterm=bold"

    call <SID>X("jsonMacroContinue", "005f00", "ffffff", "")
    exec "hi jsonMacroContinue ctermfg=22 ctermbg=NONE term=NONE cterm=NONE"

    call <SID>X("jsonMultilineString", "005fd7", "dfffff", "")
    exec "hi jsonMultilineString ctermfg=26 ctermbg=195 term=NONE cterm=NONE"

    " Folds
    call <SID>X("FoldColumn", "000000", "ffffaf", "")
    exec "hi FoldColumn ctermbg=229 term=NONE cterm=NONE"
